 ...
 * Contact: matthewdowney20@gmail.com
 * 
 * Version: 2.2
 * Date:    2/25/2015
 * 
 * Purpose: 
 *          Javauto can emulate keyboard/mouse input and perform other functions similar 
 *          to the Windows automation language AutoIt, however, being written in java, 
 *          Javauto is cross platform. 
 */
...
public class Javauto {
   /*
    * Define the environmental constants & class variables to be made available for convenient access
    */
   ...
   /**
    * The file separator on the system, usually '/' on *nix based systems
    * and '\' on Windows.
    */
   ...
   /**
    * The speed (0.00-1.00) at which events occur. 
    * This includes mouse clicks, mouse click-and-drags, mouse movements, and simulated keyboard input.
    */
   ...
   /**
    * Get the current speed. The speed controls how quickly mouse and keyboard actions
    * happen. The default speed is .95 (95%). A speed of 1.00 (100%) makes mouse and 
   ...
   /**
    * Set the current speed. The speed controls how quickly mouse and keyboard actions
    * happen. The default speed is .95 (95%). A speed of 1.00 (100%) makes mouse and 
    * keyboard actions instant.
    * @param spd The new speed as a double. This value must be between 0.00 and 1.00,
    * if it isn't no action will be taken. A speed of 1.00 will make mouse and keyboard
    * actions instant.
    */
   ...
   /**
    * Simulate keyboard input by "typing" the contents of str. 
    * Special keys can also be typed. The speed at which this typing
    * occurs can be set with {@link setSpeed}.
    * @param str The string to type, one letter (or special key) at a time. 
    */
   ...
   /**
    * Hold down a key until {@link keyUp} is called on the same key.
    * If keyUp is not called the key will become "stuck." Special
    * keys can also be used here.
    * @param str The key that will be held down. If there are multiple 
    * letters or keys specified only the first will be held down.
    */
   public void keyDown( String str ) {
	 ...
	 switch (c) {
	    ...
	    case '\u1EA8': r.keyPress(KeyEvent.VK_HOME); break;
	    case '\u1EA9': r.keyPress(KeyEvent.VK_END); break;
	    case '\u2C00': r.keyPress(KeyEvent.VK_LEFT); break;
	    case '\u2C01': r.keyPress(KeyEvent.VK_RIGHT); break;
	    case '\u2C02': r.keyPress(KeyEvent.VK_UP); break;
	    case '\u2C03': r.keyPress(KeyEvent.VK_DOWN); break;
	    case '\u2C04': r.keyPress(KeyEvent.VK_CAPS_LOCK); break;
    ...
    * @param str The single key that will be released. If more than one key is 
   ...
   public void keyUp( String str ) {
	 ...
	 switch (c) {
	    ...
	    case '\u1EA8': r.keyRelease(KeyEvent.VK_HOME); break;
	    case '\u1EA9': r.keyRelease(KeyEvent.VK_END); break;
	    case '\u2C00': r.keyRelease(KeyEvent.VK_LEFT); break;
	    case '\u2C01': r.keyRelease(KeyEvent.VK_RIGHT); break;
	    case '\u2C02': r.keyRelease(KeyEvent.VK_UP); break;
	    case '\u2C03': r.keyRelease(KeyEvent.VK_DOWN); break;
	    case '\u2C04': r.keyRelease(KeyEvent.VK_CAPS_LOCK); break;
    ...
    * Special keys can be used here.
    * @param s The single key to press or release. If more than
    * one key is specified only one key will be pressed.
    */
   ...
   /**
    * Hold down a key until {@link keyUp} is called on the same key.
    * If keyUp is not called the key will become "stuck." The helper
    * can be used to find the integer value of a key.
    * @param i Integer value of key to be pressed.
    */
    ...
    * of a key.
    * @param i Integer representation of the key that will be released.
    */
   ...
   /**
    * Simulate the press and release of a single key. 
    * @param s The integer value of the key to press.
    */
   ...
   /**
    * Send a key combination such as Ctrl + Alt + Delete. The keys
    * must be passed in as a string array.
    * @param keys The key combination to be executed as a String array. 
    * The keys in this array must be in order and may contain special keys.
    ...
    * @param keys The key combination to be executed as an int array. 
    * The keys in this array must be in order.
    * The array can be of any size.
    */
    ...
    * @param milliseconds Time to delay; must be between 0 and 60,000ms. Only takes integer values.
    */
   ...
   /**
    * Move the mouse cursor to a certain position.
    * The speed of the mouse movement can be set with {@link setSpeed}.
    * Note that mouse coordinates can be found with the Javauto Helper.
    * @param xFinal The X value of the coordinate to move the mouse to. 
    * @param yFinal The Y value of the coordinate to move the mouse to.
    */
   public void mouseMove( int xFinal, int yFinal) {

      try {
	 /* if they have speed set to highest (everything happens instantly) just move the mouse */
	 ...
	 /* this ensures that adding decimal intervals repeatedly doesn't
	    ...
	    back to this ideal value and round from there to get the closest pixel */
    ...
    * @param button either "left", "right", or "middle"
    * @param x The X value of the coordinate that will be clicked on.
    * @param y The Y value of the coordinate that willl be clicked on.
    */
   ...
   /**
    * Perform a mouse click.
    * @param button The mouse button to simulate. This value must be
   ...
   /**
    * Press down a mouse button. If {@link mouseUp}
    * is not called the mouse will be stuck down.
    * @param button The mouse button to simulate. This value must be
    * either "left", "right", or "middle".
    * @param x The X value of the coordinate that will be clicked on.
    * @param y The Y value of the coordinate that will be clicked on.
    */
   ...
   /**
    * Press down a mouse button. If {@link mouseUp} is
    * not called the mouse will be stuck down.
    * @param button The mouse button to simulate. This value must be
    * either "left", "right", or "middle".
    */
    ...
    * @param Text Text to display as a prompt.
    * @param Title Title of the dialog window.
    * @param buttons String array of button names to be available. 
    * @param defaultButton The default button to be selected when "Enter" is pressed.
    * defaultButton should be the text of the desired default button.
    * @return The index of selected button within the buttons array.
    */
   public int optionsBox(String Text, String Title, String[] buttons, String defaultButton) {
      return JOptionPane.showOptionDialog(null, Text, Title, JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, buttons, defaultButton);
   }
    ...
    * @param Text Text to be displayed as the prompt in the dialog box.
    * @param Title Title of the dialog window.
    * @param Timeout Time (in milliseconds) to wait until until the window times out automatically.
    */
   ...
   public int toInt( long l ) {
	 ...
	 throw new NumberFormatException("Cannot convert from long to integer because long exceeds Integer.MAX_VALUE (" + Integer.MAX_VALUE + ")");
      } else if ( l < Integer.MIN_VALUE ) {
	 throw new NumberFormatException("Cannot convert from long to integer because long is smaller than Integer.MIN_VALUE (" + Integer.MIN_VALUE + ")");
      }
      return (int) l;
   }
    ...
    * @param fileName Filename to save the PNG screenshot to.
    * @param x1 X value of top left coordinate.
    * @param y1 Y value of top left coordinate.
    * @param x2 X value of bottom right coordinate.
    * @param y2 Y value of bottom right coordinate.
    */
   public void screenShot( String fileName, int x1, int y1, int x2, int y2 ) {
	 ...
	 height = y1 - y2;
      ...
      /* if it's in the incredibly backwards format of (bottom right, top left) */
      else if ( (x1 > x2) && (y1 > y2) ) {
	 topLeft[0] = x2;
	 topLeft[1] = y2;
	 width = x1 - x2;
	 height = y1 - y2;
      ...
      /* if it's some other god forsaken format just quit
       * this would only happen if one of the dimesions was 0 ... so it's fine */
      else {
	 return;
      }
	 ...
	 BufferedImage img = robot.createScreenCapture(new Rectangle(topLeft[0], topLeft[1], width, height));
   ...
   /**
    * Open a file or URL in the default program. (This will be the
    * default browser if it's a URL.)
    * @param path The URL or file to open. URLs must begin with http:// or https://
   ...
   /**
    * Gets the current time in milliseconds. There are <code>1000</code> milliseconds in 1 second, so divide by 1000 to find seconds.
    * @return This method returns the difference, measured in milliseconds, between the current time and midnight, January 1, 1970 UTC(coordinated universal time).
    */
   ...
   /**
    * Gets the current value from the most precise system timer on a computer, in nanoseconds. It returns nanoseconds since some fixed but arbitrary time. This fixed time could even be in the future, resulting in a negative value. <code>getNanoTime</code> should be used to measure the time between events, not as a wall clock.<br>There are <code>1,000,000,000</code> nanoseconds in a second, and <code>1,000,000</code> nanoseconds in a millisecond. 
   ...
   /**
    * Execute a shell command and return the output. This will not display a visable process and it
    * will wait for the command to finish before continuing. On Windows systems (the os can be
    * checked with the {@link OS_SYSTEM} constant) the command string must be of the format
    * "cmd /c command".
    ...
    * @param Text Text to be displayed in the dialog box.
    * @param Title Title of the dialog box.
    * @param Choices The options in the drop-down as a string array.
    * @param Default The index of the default option in the Choices array.
    * @return The user's choice as a string.
    */
   public String inputList( String Text, String Title, String[] Choices, int Default ) {
      String choice = (String) JOptionPane.showInputDialog(null, Text, Title, JOptionPane.QUESTION_MESSAGE, null, Choices, Choices[Default]);
      return choice;
   }
   ...
   /**
    * Get a password from the user. Displays a dialog box where
    * the input is masked.
    * @param Text Text to be displayed in the dialog box.
    * @param Title Title of the dialog box.
    * @param Okay text of the okay button, eg. okay, submit, go, login, etc.
    ...
    * @param max The minimum integer value to be returned (inclusive).
    ...
    * @param i The integer value of the color.
   ...
   /**
    * Search for the coordinates of a pixel of a certain color within an area. This will
    * return the coordinates of the first pixel found within the area that matches the search
    * color.
    * @param colorInt Integer representation of the color to search for.
    * @param x1 X value of top left coordinate.
    * @param y1 Y value of top left coordinate.
    * @param x2 X value of bottom right coordinate.
    * @param y2 Y value of bottom right coordinate.
    * @param speed A value of 1-5 to describe how fast to search.
    * A speed of 2 searches twice as fast as speed 1 except it only checks 
    * every other pixel, which is fine if the color you're trying to find is more than two pixels wide.
    * @return If the color is found coordinates are returned in an int array formatted like: [x, y].
    * If the color is not found it will return [-1,-1].
    * If there is an error executing the search it will return [-3, -3].
    */
   public int[] pixelSearch ( int colorInt, int x1, int y1, int x2, int y2, int speed ) {
      try {      		
	 // get value of color to compare to pixels
	 Color color = new Color(colorInt);
	 int cVal = color.getRGB(); 

	 Robot r = new Robot();
	 // Capture the screen colors in RAM (faster than checking individual pixel colors).
	 // Start at (0,0) because that's the smallest possible, but end at (x2, y2) because
	 // in the case of multiple monitors the screen may be bigger than Java knows. Ideally we'd
	 // capture the whole screen and just search relevant parts, but we do this so we don't 
	 // accidentally truncate the region that we're searching.
	 BufferedImage screen = r.createScreenCapture(new Rectangle(0, 0, x2+1, y2+1));

	 //speed 1 - xInc = 1 yInc = 1
	 //10201 - 100%
	 //speed 2 - xInc = 2 yInc = 1
	 //5050 - 50%
	 //speed 3 - xInc = 2 yInc = 2
	 //2500 - 25%
	 //speed 4 - xInc = 3 yInc = 2
	 //1650 - 16%
	 //speed 5 - xInc = 3 yInc = 3
	 //1089 - 10%

	 // figure out how much to increment by when searching
	 // . . . obviously incrementing by one will check every
	 // pixel, by two will check every other, etc.
	 int xInc;
	 int yInc;
	 switch (speed) {
	    case 1: xInc = 1; yInc = 1; break;
	    case 2: xInc = 2; yInc = 1; break;
	    case 3: xInc = 2; yInc = 2; break;
	    case 4: xInc = 3; yInc = 2; break;
	    case 5: xInc = 3; yInc = 3; break;
	    default: xInc = 1; yInc = 1; break;
	 }


	 for (int y = y1; y <= y2; y = y + yInc) {
	    for (int x = x1; x <= x2; x = x + xInc) {
	       int col = screen.getRGB(x, y); //get the color of pixel at coords (x, y)	
	 ...
	 // if we got to here and didn't find it. . . return -1's
	 int[] returnVal = {-1,-1};
	 return returnVal;
      } catch(AWTException e) {
	 int[] returnVal = {-3,-3};
    ...
    * @param fPath Path of the file or directory to check.
    * @return Will return true if the file or directory exists, otherwise returns false.
    */
    ...
    * @param fPath Path of the file to delete.
    */
   ...
   /**
    * Create a directory.
    * @param dirName The name of the directory to create. If the directory already exists no action will be taken.
    */
    ...
    * @param fPath Path of file to be created.
    */
    ...
    * @param fPath Path of the file to write to.
    ...
    * @param fPath The path of the file to which we are appending data.
   ...
   /**
    * Put a string in the system clipboard. On Ubuntu Linux the way
    * the clipboard is handled only allows information in the clipboard
    * to be accessable while the application that put it there is running.
    * @param s String data to put in the clip board.
    */
    ...
    * @return The clip board contents as a string. Returns null if
    * the data inside the clip board cannot be read to a string.
    */
    ...
    * java program -v --file aFile.txt -o outFile.txt
    * getFlaggedArg(args, "-f|--file") would return aFile.txt.
    * @param args The String[] args from the main function. Pass them in by just saying args.
    * @param flag The flags to get values from, separated by | like -f|--file.
    ...
    * @param args The String[] args from the main function. Pass them in by just saying args.
    * @param flag The flag(s) to check for, separate possible values with a pipe |
    ...
    * @param url The URL to query, including the get parameters.
    ...
    * @param postUrl URL to send the post request to.
    * @param parameters Post parameters to send to URL. Parameters must be
    * defined in a two dimesional array like [ [key, value], [key, value], [key, value] ].
    * @return Page response as HTML.
    */
    ...
    * @param joinString The delimeter with which to join the string array.
    * @param strArray The array to join.
   ...
   /*
    * Define the private, internally used functions that support the public functions
    */

   /**
    * Replace special characters like {CTRL} or {ENTER} with arbitrary
    * unicode characters that can be recognized by other functions 
    * @param s String to replace special characters in
    * @return String with special characters replaced by appropriate unicode chracters
    */
   ...
   /**
    * Figure out which virtual key codes are associated with each character
    * and then call {@link keyType} with the right value
   ...
   private void sendChar(char c) {
	 ...
	 case '\u1EA8': keyType(KeyEvent.VK_HOME); break;
	 case '\u1EA9': keyType(KeyEvent.VK_END); break;
	 case '\u2C00': keyType(KeyEvent.VK_LEFT); break;
	 case '\u2C01': keyType(KeyEvent.VK_RIGHT); break;
	 case '\u2C02': keyType(KeyEvent.VK_UP); break;
	 case '\u2C03': keyType(KeyEvent.VK_DOWN); break;
	 case '\u2C04': keyType(KeyEvent.VK_CAPS_LOCK); break;
   ...
   /**
    * Use the java.awt.Robot class to perform a key press
    * for each int in int[] keyCodes
    * @param keyCodes int array of virtual key codes to press
    */
    ...
    * for each int in int[] keyCodes
    * @param keyCodes int array of virtual key codes to press
    * @param offset used to recursively call each virtual key code in array
    * @param length used to manage the recursive base case in calling each virtual key code in the array
    */
